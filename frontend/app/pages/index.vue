    ...
    <template #body>
        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <BaseCard>
            <template #header>
              <div class="flex items-center gap-2">
                <BaseIcon name="i-lucide-briefcase" class="w-5 h-5 text-primary" />
          ...
          <BaseCard>
            <template #header>
              <div class="flex items-center gap-2">
                <BaseIcon name="i-lucide-calendar" class="w-5 h-5 text-primary" />
          ...
          <BaseCard>
            <template #header>
              <div class="flex items-center gap-2">
                <BaseIcon name="i-lucide-message-square" class="w-5 h-5 text-primary" />
